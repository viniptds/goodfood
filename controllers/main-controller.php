 ...
 *
 */
require_once("./classes/class-UserLogin.php");
require_once("./classes/class-GoodFoodDB.php");
require_once("./add-ons/PasswordHash.php");
...
class MainController extends UserLogin
{
	...
	public function load_model( $model_name = false ) {
		...
		// Inclui o arquivo
		$model_path = ABSPATH . '/model/' . $model_name . '-model.php';
